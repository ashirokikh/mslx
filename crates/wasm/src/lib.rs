...
use mslx_core::{
    assemble::build_certification_epub, load_content_index, FetchError, Fetcher, ResolveError,
};
...
pub async fn export_book(
    ...
    progress("Loading the Microsoft Learn catalog\u{2026}");
    let index = load_content_index(&fetcher)
        .await
